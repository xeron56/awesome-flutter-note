...
```
This ListTile widget will display a list tile with a leading icon, a title, a subtitle, and a trailing icon. It will have three lines of text and a compact visual density, and will have rounded corners. It will also have a checkbox style, and will be displayed in a disabled, selected state. It will have blue leading and trailing icons, green text, and will be padded with 8 pixels on all sides. It will be disabled and will have a click cursor when hovered over. It will be selected, will have a purple focus indicator, a green hover indicator, and a yellow splash indicator. It will have a focus node, will be autofocusable, and will have orange and yellow tile colors. It will have a horizontal title gap of 8 pixels, a minimum vertical padding of 4 pixels, and a minimum leading width of 48 pixels.
